...
/*   Updated: 2025/06/28 20:59:39 by johyorti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_process_single_number_str(const char *num_str, t_stack **stack_a,
		char **arr)
{
	long	num_long;
	int		num_int;
...
static void	ft_parse_individual_arguments(int argc, char **argv,
		t_stack **stack_a)
{
	int	i;
